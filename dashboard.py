...
plot_choice = st.selectbox("Choose a plot:",
                               ("Scatter Small Towns vs Fed",
                                "Scatter More Small Towns vs Fed",
...
elif (plot_choice == "Scatter Small Towns vs Fed"):
     st.image('Plots/small_towns_fed_2.png')
elif (plot_choice == "Scatter More Small Towns vs Fed"):
     st.image('Plots/small_towns_fed_1.png')